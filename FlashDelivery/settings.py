"""
Django settings for FlashDelivery project.
...
SECRET_KEY = 'vjao-%s%kk8m5iwn)s@r_t&t!bv&h+su)+a!av&)#gobg1#7sf'
...
ROOT_URLCONF = 'FlashDelivery.urls'
...
WSGI_APPLICATION = 'FlashDelivery.wsgi.application'
